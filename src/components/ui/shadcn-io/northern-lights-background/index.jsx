...
export const NorthernLightsBackground = forwardRef(({
  className,
  ...
  propsRef.current = { colorStops, amplitude, blend, time, speed, ...props };
  ...
  useEffect(() => {
    ...
    const update = (t) => {
      ...
      const currentSpeed = currentProps.speed ?? 1.0;
...
NorthernLightsBackground.displayName = 'NorthernLightsBackground';